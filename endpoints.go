...
func weatherEndpoint(lang language.Tag, latitude float64, longitude float64, values url.Values) string {
...
func weatherAlertEndpoint(lang language.Tag, id string) string {
